            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__left">
                        <ul>
                            <li><i class="fa fa-envelope"></i> tainahe176053@fpt.edu.vn</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="col-lg-3">
                <div class="header__logo">
                    <c:if test="${sessionScope.user.role != 1}">
                        <a href="content"><h2 style="color: #7fad39">Shop food</h2></a>
                    </c:if>

                    <c:if test="${sessionScope.user.role == 1}">
                        <a href="admin-index.jsp"><h2 style="color: #7fad39">Shop food</h2></a>
                    </c:if>
